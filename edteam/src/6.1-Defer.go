...
func main() {
	/*
		// DEFER, Permite diferir, aplazar la ejecución de una funcion. Hasta donde finalice la ejecucion de la funcion donde fue llamado el "Defer"
	...
	*/
	/*
		...
		fmt.Printf("Usando renglones de DEFER \n")
	...
	*/
	...
	var a uint8 = 5
	defer fmt.Printf("Usando Defer : valor de a = %d \n ", a)
